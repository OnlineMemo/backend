...
public class TokenProvider {
    ...
    public TokenProvider(ObjectMapper objectMapper, @Value("${jwt.secret}") String secretKey) {
        this.claimsReader = objectMapper.readerFor(Map.class);  // objectMapper는 Bean 등록이 되어있음. (재사용성 최적화)
